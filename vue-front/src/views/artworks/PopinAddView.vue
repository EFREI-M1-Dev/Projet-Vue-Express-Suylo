...
<template>
	<div class='popin__content__block-img'>
		<input id='upPicture' type='file' @change='onPictureChange' hidden='' />
	...
	<div class='popin__content__text'>
		...
		<p class='title small'>
			* Titre :
			<input type='text' v-model='title' placeholder="Le titre de l'oeuvre" class='input' name='title'>
		</p>
		<p class='artist small'>
			* Artiste :
			<select v-model='artist' class='input' name='artist'>
		...
		<p class='description small'>
			Description :
			<input type='text' v-model='description' placeholder='Sa description' class='input' name='desc'>
		</p>
		<p class='price small'>
			Prix estimé :
